...
.equ WDSIZE, 4 // Size of element in bytes ( 4 bytes = 1 word)

// X0-x18: corrupitble registers that we are free to use as we want
// X19-X30: Callee saved, push to stack if we use them
main:
...
printloop:
	...
	// use post-indexing to move through elements
...
// Matrices are stored in row order, i.e.
// iterating through columns of each row first,
